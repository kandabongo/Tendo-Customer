...
class WelcomeSimpleHeaderSection extends StatelessWidget {
  const WelcomeSimpleHeaderSection(this.vm, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return VStack([
      HStack([
        Icon(FlutterIcons.location_pin_ent, size: 24, color: themeTextColor),
        VStack([
          "Deliver To".tr().text.thin.light.color(themeTextColor).sm.make(),
        ...
        Icon(FlutterIcons.chevron_down_ent, size: 20, color: themeTextColor),
        //
        Spacer(),
        Icon(FlutterIcons.bell_fea, size: 20, color: themeTextColor).onInkTap(
          () {
            context.nextPage(NotificationsPage());
          },
        ),
      ], spacing: 6).px20().onTap(() async {
