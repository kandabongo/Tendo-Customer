...
class NewTaxiOrderSummaryCollapsed extends StatelessWidget {
      ...
      child:
          VStack([
                VStack([
                  ...
                  //vehicle types
                  NewTaxiVehicleTypeListView(vm: vm).wFull(context),
                ]),
                Divider(
                  ...
                  HStack([
                    ...
                    VxBadge(
                      child: _boxedButton(
                        child: IconButton(
                          onPressed:
                              newTaxiOrderSummaryViewModel.openCoupnDialog,
                          icon: Icon(
                            Icons.local_offer,
                      ...
                      size: 20,
                      count:
                          newTaxiOrderSummaryViewModel.taxiViewModel.coupon !=
                                  null
                              ? 1
                              : 0,
                    ),
                    ...
                    _boxedButton(
                      child: Builder(
                        builder: (context) {
                          Widget tipIcon = IconButton(
                            onPressed:
                                newTaxiOrderSummaryViewModel.openTipDialog,
                            icon: HugeIcon(
                          ...
                          if (newTaxiOrderSummaryViewModel.taxiViewModel.tip >
                              0) {
                            return VxBadge(
                              child: tipIcon,
                              color: AppColor.primaryColor,
  ...
  //MICS.
  Widget _boxedButton({required Widget child}) {
    return child.box.roundedSM.color(Utils.systemGreyColor()).px8.make();
  }
}
